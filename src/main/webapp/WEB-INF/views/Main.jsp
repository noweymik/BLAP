...
<div class="container border mt-4 mb-4" style="border:1px solid; border-radius: 10px; height:375px;">
 ...
 <!-- <div class=" container-fluid  col-sm-3 p-3 border" style="border:1px solid; border-radius: 10px; height:375px;">
    <br>
    <canvas id="verticalChart" style="weight:60%; height:100%; padding: 10px;"></canvas>
    <canvas id="doughnut-chart" width=300 height=150></canvas> 
